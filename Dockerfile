...
RUN mkdir -p $(go env GOPATH)/src/github.com/kevinjqiu/coredns-dockerdiscovery && mv /tmp/coredns-dockerdiscovery $(go env GOPATH)/src/github.com/kevinjqiu/coredns-dockerdiscovery
